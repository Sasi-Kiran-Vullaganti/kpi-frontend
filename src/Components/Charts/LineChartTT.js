...
class LineChartTT extends Component{
  saveCanvas(){
    const canvasSave = document.getElementById('line-tt');
...
borderColor: [
        ...
        return (
          <div>
              <div>
                <div>
                <h3 className="App">TIme Taken - <strong>Line Chart</strong></h3>
            </div>
          <div>
              
            <Line id="line-tt" data={data} height={400} options={options} />
          </div>
          <div>
